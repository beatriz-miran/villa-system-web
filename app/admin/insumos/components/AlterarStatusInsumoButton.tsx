...
import {
  alterarStatusInsumoAction,
  AlterarStatusInsumoActionState,
} from "@/app/admin/insumos/actions";

type AlterarStatusInsumoButtonProps = {
  insumoId: number;
  status: "ATIVO" | "INATIVO";
};

const estadoInicial: AlterarStatusInsumoActionState = {};

export default function AlterarStatusInsumoButton({
  insumoId,
  status,
}: AlterarStatusInsumoButtonProps) {
  ...
  const insumoAtivo = status === "ATIVO";
  const novoStatus = insumoAtivo ? "INATIVO" : "ATIVO";
  ...
  return (
    <>
      ...
      >
        <input type="hidden" name="id" value={insumoId} />
